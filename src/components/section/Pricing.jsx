    ...
    <>
      <section className='py-24 bg-white'>
        <div className="container">
          ...
          <div className="flex flex-col gap-6 items-center mt-10 lg:ml-[80px] lg:flex-row lg:items-end lg:justify-center">
            {pricingTiers.map(({
              title,
              monthlyPrice,
              buttonText,
                ...
                <div className="flex justify-between">
                  ...
                  {popular && (
                    <div className="inline-flex text-sm px-4 py-1.5 rounded-xl border border-white/20">
                      ...
                      className="bg-[linear-gradient(to_right,#dd7ddf,#e1cd86,#bbcb92,#71c2ef,#dd7ddf,#e1cd86,#bbcb92,#71c2ef,#3bffff,#dd7ddf)] [background-size:200%] text-transparent bg-clip-text font-medium">Popular</motion.span>
                    </div>
                  )}
                </div>
